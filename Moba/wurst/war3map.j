...
function CreateBuildingsForPlayer11 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h005', 6592.0, 7360.0, 270.000)
    set u=CreateUnit(p, 'h007', 6912.0, 6144.0, 270.000)
    set u=CreateUnit(p, 'h007', 7552.0, 8960.0, 270.000)
    set u=CreateUnit(p, 'h005', 7360.0, 6592.0, 270.000)
    set u=CreateUnit(p, 'h007', 7168.0, 5888.0, 270.000)
    set u=CreateUnit(p, 'h007', 7168.0, 6272.0, 270.000)
    set u=CreateUnit(p, 'h007', 6272.0, 8960.0, 270.000)
    set u=CreateUnit(p, 'h007', 7424.0, 6144.0, 270.000)
    set gg_unit_h00A_0064=CreateUnit(p, 'h00A', 6720.0, 8384.0, 270.000)
    set u=CreateUnit(p, 'h004', 9024.0, 7872.0, 270.000)
    set u=CreateUnit(p, 'h009', 8704.0, 7296.0, 270.000)
    set u=CreateUnit(p, 'h004', 7872.0, 9024.0, 270.000)
    set gg_unit_h003_0070=CreateUnit(p, 'h003', 7744.0, 7744.0, 270.000)
    set u=CreateUnit(p, 'h007', 6016.0, 8704.0, 270.000)
    set u=CreateUnit(p, 'h007', 6400.0, 8576.0, 270.000)
    set u=CreateUnit(p, 'h007', 6656.0, 8832.0, 270.000)
    set gg_unit_h003_0074=CreateUnit(p, 'h003', 7744.0, 8512.0, 270.000)
    set u=CreateUnit(p, 'h007', 6144.0, 6912.0, 270.000)
    set gg_unit_h003_0076=CreateUnit(p, 'h003', 8512.0, 7744.0, 270.000)
    set u=CreateUnit(p, 'h006', 5824.0, 8256.0, 270.000)
    set u=CreateUnit(p, 'h007', 8832.0, 6656.0, 270.000)
    set u=CreateUnit(p, 'h007', 8576.0, 6400.0, 270.000)
    set u=CreateUnit(p, 'h007', 8704.0, 6016.0, 270.000)
    set u=CreateUnit(p, 'h007', 8960.0, 6272.0, 270.000)
    set u=CreateUnit(p, 'h007', 9088.0, 6016.0, 270.000)
    set u=CreateUnit(p, 'h007', 8832.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 8192.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 9088.0, 7296.0, 270.000)
    set u=CreateUnit(p, 'h007', 8960.0, 7552.0, 270.000)
    set u=CreateUnit(p, 'h009', 7296.0, 8704.0, 270.000)
    set u=CreateUnit(p, 'h007', 6144.0, 7424.0, 270.000)
    set u=CreateUnit(p, 'h007', 6272.0, 7168.0, 270.000)
    set u=CreateUnit(p, 'h007', 6016.0, 9088.0, 270.000)
    set u=CreateUnit(p, 'h009', 7040.0, 7552.0, 270.000)
    set u=CreateUnit(p, 'h009', 7552.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 5888.0, 7168.0, 270.000)
    set u=CreateUnit(p, 'h007', 7296.0, 9088.0, 270.000)
    set gg_unit_h00A_0095=CreateUnit(p, 'h00A', 8384.0, 6720.0, 270.000)
    set u=CreateUnit(p, 'h007', 7040.0, 8192.0, 270.000)
    set u=CreateUnit(p, 'h001', 8576.0, 8576.0, 270.000)
    set u=CreateUnit(p, 'h006', 6592.0, 5952.0, 270.000)
    set u=CreateUnit(p, 'h006', 5952.0, 6592.0, 270.000)
    set u=CreateUnit(p, 'h007', 7040.0, 8832.0, 270.000)
    set u=CreateUnit(p, 'h006', 7488.0, 5824.0, 270.000)
    set u=CreateUnit(p, 'h006', 5824.0, 7488.0, 270.000)
    set u=CreateUnit(p, 'h006', 8256.0, 5824.0, 270.000)
    set u=CreateUnit(p, 'n000', 9536.0, 9536.0, 270.000)
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set gg_unit_n00I_0048=CreateUnit(p, 'n00I', - 4916.4, 9119.8, 336.110)
    call SetUnitAcquireRange(gg_unit_n00I_0048, 200.0)
    set gg_unit_n00I_0098=CreateUnit(p, 'n00I', 9056.2, - 5043.9, 153.520)
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_CornerTop=Rect(- 3136.0, 6848.0, - 2752.0, 7232.0)
    set gg_rct_CornerBot=Rect(6848.0, - 3136.0, 7232.0, - 2752.0)
    ...
    set gg_rct_BrownMid=Rect(5632.0, 5632.0, 6144.0, 6144.0)
    ...
    set gg_rct_BrownCastle=Rect(8064.0, 8064.0, 8576.0, 8576.0)
    set gg_rct_BrownSpawnBot=Rect(8192.0, 7424.0, 8448.0, 7680.0)
    set gg_rct_BrownSpawnMid=Rect(7424.0, 7424.0, 7680.0, 7680.0)
    set gg_rct_BrownSpawnTop=Rect(7424.0, 8192.0, 7680.0, 8448.0)
    set gg_rct_BrownBot=Rect(7552.0, 4992.0, 8064.0, 5504.0)
    set gg_rct_BrownTop=Rect(4992.0, 7552.0, 5504.0, 8064.0)
    set gg_rct_CornerTopGreen=Rect(- 3520.0, 6464.0, - 3136.0, 6848.0)
    set gg_rct_CornerTopBrown=Rect(- 2752.0, 7232.0, - 2368.0, 7616.0)
    set gg_rct_CornerBotGreen=Rect(6464.0, - 3520.0, 6848.0, - 3136.0)
    set gg_rct_CornerBotBrown=Rect(7232.0, - 2752.0, 7616.0, - 2368.0)
    set gg_rct_GreenShops1=Rect(- 5120.0, - 4736.0, - 4992.0, - 3968.0)
    set gg_rct_GreenShops2=Rect(- 4736.0, - 5120.0, - 3968.0, - 4992.0)
    set gg_rct_BrownShops1=Rect(9088.0, 8064.0, 9216.0, 8832.0)
    set gg_rct_BrownShops2=Rect(8064.0, 9088.0, 8832.0, 9216.0)
    set gg_rct_GreenWorkShopTop=Rect(- 4224.0, - 2560.0, - 3968.0, - 2304.0)
    set gg_rct_GreenWorkShopBot=Rect(- 2560.0, - 4224.0, - 2304.0, - 3968.0)
    set gg_rct_BrownWorkShopTop=Rect(6400.0, 8064.0, 6656.0, 8320.0)
    set gg_rct_BrownWorkShopBot=Rect(8064.0, 6400.0, 8320.0, 6656.0)
    set gg_rct_BrownBase=Rect(5504.0, 5504.0, 9280.0, 9280.0)
    set gg_rct_GreenBase=Rect(- 5184.0, - 5184.0, - 1408.0, - 1408.0)
    set gg_rct_GreenAltar=Rect(- 4992.0, - 4992.0, - 4864.0, - 4864.0)
    set gg_rct_BrownAltar=Rect(8960.0, 8960.0, 9088.0, 9088.0)
    set gg_rct_GreenMilitiaDespawn=Rect(- 4800.0, - 4800.0, - 4160.0, - 4160.0)
    set gg_rct_BrownMilitiaDespawn=Rect(8256.0, 8256.0, 8896.0, 8896.0)
    set gg_rct_BrownPortBot=Rect(8384.0, - 1600.0, 8768.0, - 1216.0)
    set gg_rct_GreenPortBot=Rect(5312.0, - 4672.0, 5696.0, - 4288.0)
    set gg_rct_GreenPortTop=Rect(- 4672.0, 5312.0, - 4288.0, 5696.0)
    set gg_rct_BrownPortTop=Rect(- 1600.0, 8384.0, - 1216.0, 8768.0)
    ...
    set gg_rct_BrownBotHome=Rect(7296.0, 4864.0, 8320.0, 5632.0)
    set gg_rct_BrownMidHome=Rect(5376.0, 5376.0, 6400.0, 6400.0)
    set gg_rct_BrownTopHome=Rect(4864.0, 7296.0, 5632.0, 8320.0)
    set gg_rct_GreenBaseVision1=Rect(- 8192.0, - 8192.0, - 2560.0, - 1536.0)
    set gg_rct_GreenBaseVision2=Rect(- 2560.0, - 8192.0, - 1536.0, - 2560.0)
    set gg_rct_BrownBaseVision1=Rect(6656.0, 5536.0, 12288.0, 12288.0)
    set gg_rct_BrownBaseVision2=Rect(5632.0, 6560.0, 6656.0, 12192.0)
endfunction
...
function Trig_Init_Actions takes nothing returns nothing
    ...
    endloop
    call CreateAltars()
    call ForForce(GetPlayersAll(), function Trig_Init_Func014A)
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(10, - 3648.0, - 3648.0)
    call DefineStartLocation(11, 7744.0, 7744.0)

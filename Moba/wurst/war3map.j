...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h00C', - 1620.1, 2461.5, 118.942)
    set u=CreateUnit(p, 'h00C', - 1567.7, 2060.7, 51.967)
    set u=CreateUnit(p, 'h00C', - 786.9, 2047.8, 347.157)
    set u=CreateUnit(p, 'h00C', 121.5, 2465.8, 313.450)
    set u=CreateUnit(p, 'h00C', 10.9, 1649.1, 182.631)
    set u=CreateUnit(p, 'h00C', - 1548.1, 716.9, 152.286)
    set u=CreateUnit(p, 'h00C', - 1961.3, 1178.8, 315.658)
    set u=CreateUnit(p, 'h00C', - 2218.5, 807.7, 262.592)
    set u=CreateUnit(p, 'h00C', - 2575.6, 84.3, 153.934)
    set u=CreateUnit(p, 'h00C', - 2584.2, 1078.7, 237.806)
    set u=CreateUnit(p, 'h00C', 1777.0, - 662.7, 23.687)
    set u=CreateUnit(p, 'h00C', 1925.9, - 1117.1, 124.358)
    set u=CreateUnit(p, 'h00C', 2460.2, - 421.3, 249.694)
    set u=CreateUnit(p, 'h00C', 2586.9, - 882.1, 271.448)
    set u=CreateUnit(p, 'h00C', 1584.8, - 1981.0, 350.222)
    set u=CreateUnit(p, 'h00C', 855.6, - 2025.9, 177.523)
    set u=CreateUnit(p, 'h00C', 2366.1, - 3153.4, 39.145)
    set u=CreateUnit(p, 'h00C', - 185.5, - 2598.1, 85.454)
endfunction

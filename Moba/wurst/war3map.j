...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'nmtw', - 217.8, 1855.1, 261.768)
    set u=CreateUnit(p, 'nmtw', - 382.7, 1677.7, 8.745)
    set u=CreateUnit(p, 'nmtw', - 659.4, 1026.2, 76.907)
    set u=CreateUnit(p, 'nmtw', 21.1, 1254.3, 134.664)
    set u=CreateUnit(p, 'nmtw', 339.7, 1867.7, 34.872)
    set u=CreateUnit(p, 'nmtw', - 1635.9, 2295.3, 90.805)
    set u=CreateUnit(p, 'nmtw', - 1938.1, 2637.4, 216.185)
    set u=CreateUnit(p, 'nmtw', - 2538.3, 884.3, 49.528)
    set u=CreateUnit(p, 'nmtw', - 2290.3, 1034.8, 169.821)
    set u=CreateUnit(p, 'nmtw', 1658.4, - 675.7, 22.731)
    set u=CreateUnit(p, 'nmtw', 1903.0, - 1202.3, 30.301)
    set u=CreateUnit(p, 'nmtw', 920.1, - 1962.0, 125.303)
    set u=CreateUnit(p, 'nmtw', 1585.8, - 2252.8, 343.355)
    set u=CreateUnit(p, 'nmtw', 2193.8, - 2929.3, 145.562)
    set u=CreateUnit(p, 'nmtw', 3183.2, - 881.3, 170.238)
    set u=CreateUnit(p, 'nmtw', 2592.7, - 324.5, 69.666)
    set u=CreateUnit(p, 'nmtw', 733.9, - 3109.3, 316.746)
    set u=CreateUnit(p, 'nmtw', - 147.5, - 2496.2, 357.045)
    set u=CreateUnit(p, 'nmtw', - 2853.8, - 40.5, 218.712)
    set u=CreateUnit(p, 'nmtw', - 2974.3, 987.3, 121.996)
    set u=CreateUnit(p, 'nmtw', - 2352.9, 3043.5, 131.236)
    set u=CreateUnit(p, 'nmtw', - 1472.4, 364.0, 168.096)
endfunction

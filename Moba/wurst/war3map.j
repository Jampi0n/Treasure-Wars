...
rect gg_rct_Shop0= null
rect gg_rct_Shop1= null
rect gg_rct_Shop2= null
rect gg_rct_Shop3= null
rect gg_rct_Shop4= null
rect gg_rct_Shop5= null
rect gg_rct_Shop6= null
rect gg_rct_Shop7= null
rect gg_rct_Shop8= null
rect gg_rct_Shop9= null
...
function CreateBuildingsForPlayer10 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h007', - 1664.0, - 384.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1792.0, - 896.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1280.0, - 3584.0, 270.000)
    set u=CreateUnit(p, 'h007', - 2816.0, - 768.0, 270.000)
    set gg_unit_h00A_0013=CreateUnit(p, 'h00A', - 1216.0, - 3904.0, 270.000)
    set gg_unit_h004_0014=CreateUnit(p, 'h004', - 3648.0, - 2496.0, 270.000)
    set u=CreateUnit(p, 'h009', - 2944.0, - 3456.0, 270.000)
    set u=CreateUnit(p, 'h005', - 2752.0, - 1728.0, 270.000)
    set gg_unit_h004_0017=CreateUnit(p, 'h004', - 2496.0, - 3648.0, 270.000)
    set u=CreateUnit(p, 'h005', - 1728.0, - 2752.0, 270.000)
    set gg_unit_h003_0019=CreateUnit(p, 'h003', - 2368.0, - 2368.0, 270.000)
    set u=CreateUnit(p, 'h007', - 768.0, - 2816.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1024.0, - 2944.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1280.0, - 4224.0, 270.000)
    set gg_unit_h003_0023=CreateUnit(p, 'h003', - 2112.0, - 3264.0, 270.000)
    set u=CreateUnit(p, 'h007', - 768.0, - 1536.0, 270.000)
    set gg_unit_h003_0025=CreateUnit(p, 'h003', - 3264.0, - 2112.0, 270.000)
    set u=CreateUnit(p, 'h006', - 448.0, - 2880.0, 270.000)
    set gg_unit_n000_0027=CreateUnit(p, 'n000', - 4544.0, - 4544.0, 270.000)
    set u=CreateUnit(p, 'h007', - 3584.0, - 1280.0, 270.000)
    set u=CreateUnit(p, 'h007', - 2944.0, - 1024.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1920.0, - 1280.0, 270.000)
    set u=CreateUnit(p, 'h007', - 3840.0, - 768.0, 270.000)
    set u=CreateUnit(p, 'h007', - 4224.0, - 1280.0, 270.000)
    set u=CreateUnit(p, 'h007', - 3584.0, - 1664.0, 270.000)
    ...
    set u=CreateUnit(p, 'h007', - 1280.0, - 1920.0, 270.000)
    set u=CreateUnit(p, 'h007', - 896.0, - 1792.0, 270.000)
    set u=CreateUnit(p, 'h007', - 768.0, - 3840.0, 270.000)
    set u=CreateUnit(p, 'h009', - 2304.0, - 2944.0, 270.000)
    set u=CreateUnit(p, 'h009', - 2944.0, - 2304.0, 270.000)
    set u=CreateUnit(p, 'h007', - 384.0, - 1664.0, 270.000)
    set u=CreateUnit(p, 'h007', - 1920.0, - 3712.0, 270.000)
    set gg_unit_h00A_0045=CreateUnit(p, 'h00A', - 3904.0, - 1216.0, 270.000)
    ...
    set u=CreateUnit(p, 'h007', - 1664.0, - 3584.0, 270.000)
    set u=CreateUnit(p, 'h006', - 3648.0, - 448.0, 270.000)
    set u=CreateUnit(p, 'h006', - 448.0, - 3648.0, 270.000)
    set u=CreateUnit(p, 'h006', - 2880.0, - 448.0, 270.000)
    set u=CreateUnit(p, 'h016', 4992.0, - 2816.0, 270.000)
    set u=CreateUnit(p, 'h016', - 2816.0, 4864.0, 270.000)
    set u=CreateUnit(p, 'h016', - 2880.0, 3008.0, 270.000)
    set u=CreateUnit(p, 'h016', 2880.0, - 2880.0, 270.000)
    set u=CreateUnit(p, 'h016', 1024.0, 1024.0, 270.000)
endfunction
...
function CreateBuildingsForPlayer11 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h009', 7040.0, 7552.0, 270.000)
    set u=CreateUnit(p, 'h005', 5824.0, 6848.0, 270.000)
    set u=CreateUnit(p, 'h007', 5632.0, 4864.0, 270.000)
    set u=CreateUnit(p, 'h007', 6272.0, 7680.0, 270.000)
    set u=CreateUnit(p, 'h005', 6848.0, 5824.0, 270.000)
    set u=CreateUnit(p, 'h007', 5760.0, 4480.0, 270.000)
    set u=CreateUnit(p, 'h007', 5888.0, 4992.0, 270.000)
    set u=CreateUnit(p, 'h007', 5376.0, 8320.0, 270.000)
    set u=CreateUnit(p, 'h007', 6016.0, 5376.0, 270.000)
    set gg_unit_h00A_0064=CreateUnit(p, 'h00A', 5312.0, 8000.0, 270.000)
    set gg_unit_h004_0065=CreateUnit(p, 'h004', 7744.0, 6592.0, 270.000)
    set u=CreateUnit(p, 'h009', 7040.0, 6400.0, 270.000)
    set gg_unit_h004_0068=CreateUnit(p, 'h004', 6592.0, 7744.0, 270.000)
    set gg_unit_h003_0070=CreateUnit(p, 'h003', 6464.0, 6464.0, 270.000)
    set u=CreateUnit(p, 'h007', 4864.0, 6912.0, 270.000)
    set u=CreateUnit(p, 'h007', 5120.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 5376.0, 7680.0, 270.000)
    set gg_unit_h003_0074=CreateUnit(p, 'h003', 6208.0, 7360.0, 270.000)
    set u=CreateUnit(p, 'h007', 4864.0, 5632.0, 270.000)
    set gg_unit_h003_0076=CreateUnit(p, 'h003', 7360.0, 6208.0, 270.000)
    set u=CreateUnit(p, 'h006', 4544.0, 6976.0, 270.000)
    set u=CreateUnit(p, 'h007', 7680.0, 5376.0, 270.000)
    set u=CreateUnit(p, 'h007', 7040.0, 5120.0, 270.000)
    set u=CreateUnit(p, 'h007', 6912.0, 4864.0, 270.000)
    set u=CreateUnit(p, 'h007', 8320.0, 5376.0, 270.000)
    set u=CreateUnit(p, 'h007', 7936.0, 4864.0, 270.000)
    set u=CreateUnit(p, 'h007', 7680.0, 5760.0, 270.000)
    ...
    set u=CreateUnit(p, 'h009', 6400.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 5376.0, 6016.0, 270.000)
    set u=CreateUnit(p, 'h007', 4992.0, 5888.0, 270.000)
    set u=CreateUnit(p, 'h007', 4864.0, 7936.0, 270.000)
    set u=CreateUnit(p, 'h009', 7552.0, 7040.0, 270.000)
    set u=CreateUnit(p, 'h007', 4480.0, 5760.0, 270.000)
    set u=CreateUnit(p, 'h007', 6016.0, 7808.0, 270.000)
    set gg_unit_h00A_0095=CreateUnit(p, 'h00A', 8000.0, 5312.0, 270.000)
    ...
    set u=CreateUnit(p, 'h007', 5760.0, 7680.0, 270.000)
    set u=CreateUnit(p, 'h006', 6976.0, 4544.0, 270.000)
    set u=CreateUnit(p, 'h006', 4544.0, 7744.0, 270.000)
    set u=CreateUnit(p, 'h006', 7744.0, 4544.0, 270.000)
    set gg_unit_n000_0105=CreateUnit(p, 'n000', 8640.0, 8640.0, 270.000)
    set u=CreateUnit(p, 'h016', 6912.0, - 768.0, 270.000)
    set u=CreateUnit(p, 'h016', - 896.0, 6912.0, 270.000)
    set u=CreateUnit(p, 'h016', 1216.0, 6976.0, 270.000)
    set u=CreateUnit(p, 'h016', 6976.0, 1088.0, 270.000)
    set u=CreateUnit(p, 'h016', 3072.0, 3072.0, 270.000)
endfunction
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_Shop0=Rect(15872.0, - 7680.0, 19968.0, - 6144.0)
    set gg_rct_Shop1=Rect(15872.0, - 6144.0, 19968.0, - 4608.0)
    set gg_rct_Shop2=Rect(15872.0, - 4608.0, 19968.0, - 3072.0)
    set gg_rct_Shop3=Rect(15872.0, - 3072.0, 19968.0, - 1536.0)
    set gg_rct_Shop4=Rect(15872.0, - 1536.0, 19968.0, 0.0)
    set gg_rct_Shop5=Rect(15872.0, 0.0, 19968.0, 1536.0)
    set gg_rct_Shop6=Rect(15872.0, 1536.0, 19968.0, 3072.0)
    set gg_rct_Shop7=Rect(15872.0, 3072.0, 19968.0, 4608.0)
    set gg_rct_Shop8=Rect(15872.0, 4608.0, 19968.0, 6144.0)
    set gg_rct_Shop9=Rect(15872.0, 6144.0, 19968.0, 7680.0)
endfunction

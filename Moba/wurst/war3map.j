...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set gg_unit_n00K_0007=CreateUnit(p, 'n00K', 7874.5, - 3652.8, 125.500)
    ...
    call SetUnitState(u, UNIT_STATE_MANA, 0)
    set u=CreateUnit(p, 'n00S', - 1468.5, 4702.1, - 67.029)
    set u=CreateUnit(p, 'n00S', - 1581.3, 4593.4, - 43.950)
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_BrownPortBot=Rect(6912.0, 352.0, 7296.0, 736.0)
    set gg_rct_GreenPortBot=Rect(3040.0, - 3200.0, 3424.0, - 2816.0)
    set gg_rct_GreenPortTop=Rect(- 3040.0, 3360.0, - 2656.0, 3744.0)
    set gg_rct_BrownPortTop=Rect(224.0, 7104.0, 608.0, 7488.0)

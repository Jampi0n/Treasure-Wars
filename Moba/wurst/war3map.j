...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'h00E', - 1368.4, - 1573.8, 242.706)
    set u=CreateUnit(p, 'h00E', - 1309.2, - 1701.1, 99.243)
    set u=CreateUnit(p, 'h00E', - 1313.4, - 1539.3, 24.775)
    set u=CreateUnit(p, 'h00E', - 1234.8, - 1661.4, 25.621)
    set u=CreateUnit(p, 'h00E', - 1205.5, - 1490.7, 355.649)
    set u=CreateUnit(p, 'h00E', - 1154.7, - 1609.3, 345.080)
    set u=CreateUnit(p, 'h00E', - 1138.5, - 1482.2, 135.927)
    set u=CreateUnit(p, 'h00E', - 1094.0, - 1559.6, 54.725)
    set u=CreateUnit(p, 'h00E', - 1033.1, - 1647.0, 349.343)
    set u=CreateUnit(p, 'h00E', - 1100.2, - 1687.9, 64.327)
    set u=CreateUnit(p, 'h00E', - 1212.3, - 1743.9, 141.541)
    set u=CreateUnit(p, 'h00E', - 1256.4, - 1803.3, 49.242)
endfunction
...
function config takes nothing returns nothing
    ...
    call DefineStartLocation(1, - 4480.0, - 5440.0)
    call DefineStartLocation(2, - 3968.0, - 5504.0)
    call DefineStartLocation(3, - 3456.0, - 5440.0)
    call DefineStartLocation(4, - 2944.0, - 5440.0)
    call DefineStartLocation(5, 4992.0, 5504.0)
    call DefineStartLocation(6, 4480.0, 5504.0)
    call DefineStartLocation(7, 3968.0, 5504.0)
    call DefineStartLocation(8, 3456.0, 5504.0)
    call DefineStartLocation(9, 2944.0, 5440.0)

...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set gg_unit_n00I_0048=CreateUnit(p, 'n00I', - 4457.5, 4704.6, 336.110)
    call SetUnitAcquireRange(gg_unit_n00I_0048, 200.0)
    set gg_unit_n00I_0098=CreateUnit(p, 'n00I', 4547.6, - 4638.4, 153.520)

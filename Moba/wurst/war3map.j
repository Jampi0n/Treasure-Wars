...
unit array udg_BrownBlacksmith
unit array udg_GreenBlacksmith
...
rect gg_rct_BrownHeroTower= null
rect gg_rct_GreenHeroTower= null
...
function CreateBuildingsForPlayer10 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h009', - 3456.0, - 2944.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1536.0, - 768.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 2176.0, - 3584.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1664.0, - 384.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1792.0, - 896.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1280.0, - 3584.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 2816.0, - 768.0, 270.000, 'h007')
    set gg_unit_h00A_0013=BlzCreateUnitWithSkin(p, 'h00A', - 1216.0, - 3904.0, 270.000, 'h00A')
    set gg_unit_h004_0014=BlzCreateUnitWithSkin(p, 'h004', - 3648.0, - 2496.0, 270.000, 'h004')
    set u=BlzCreateUnitWithSkin(p, 'h009', - 2944.0, - 3456.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h005', - 2752.0, - 1728.0, 270.000, 'h005')
    set gg_unit_h004_0017=BlzCreateUnitWithSkin(p, 'h004', - 2496.0, - 3648.0, 270.000, 'h004')
    set u=BlzCreateUnitWithSkin(p, 'h005', - 1728.0, - 2752.0, 270.000, 'h005')
    set gg_unit_h003_0019=BlzCreateUnitWithSkin(p, 'h003', - 2368.0, - 2368.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 768.0, - 2816.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1024.0, - 2944.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1280.0, - 4224.0, 270.000, 'h007')
    set gg_unit_h003_0023=BlzCreateUnitWithSkin(p, 'h003', - 2112.0, - 3264.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 768.0, - 1536.0, 270.000, 'h007')
    set gg_unit_h003_0025=BlzCreateUnitWithSkin(p, 'h003', - 3264.0, - 2112.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 448.0, - 2880.0, 270.000, 'h006')
    set gg_unit_n000_0027=BlzCreateUnitWithSkin(p, 'n000', - 4544.0, - 4544.0, 270.000, 'n000')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 3584.0, - 1280.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 2944.0, - 1024.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1920.0, - 1280.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 3840.0, - 768.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 4224.0, - 1280.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 3584.0, - 1664.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 2816.0, - 1408.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 3712.0, - 1920.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 3584.0, - 2176.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1280.0, - 1920.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 896.0, - 1792.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 768.0, - 3840.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h009', - 2304.0, - 2944.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h009', - 2944.0, - 2304.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 384.0, - 1664.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1920.0, - 3712.0, 270.000, 'h007')
    set gg_unit_h00A_0045=BlzCreateUnitWithSkin(p, 'h00A', - 3904.0, - 1216.0, 270.000, 'h00A')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1408.0, - 2816.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h001', - 3200.0, - 3200.0, 270.000, 'h001')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 1216.0, - 576.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 576.0, - 1216.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h007', - 1664.0, - 3584.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 3648.0, - 448.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 448.0, - 3648.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', - 2880.0, - 448.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h016', 4992.0, - 2816.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', - 2816.0, 4864.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', - 2880.0, 3008.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', 2880.0, - 2880.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', 1024.0, 1024.0, 270.000, 'h016')
endfunction
...
function CreateBuildingsForPlayer11 takes nothing returns nothing
    ...
    set u=BlzCreateUnitWithSkin(p, 'h009', 7040.0, 7552.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h005', 5824.0, 6848.0, 270.000, 'h005')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5632.0, 4864.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 6272.0, 7680.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h005', 6848.0, 5824.0, 270.000, 'h005')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5760.0, 4480.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5888.0, 4992.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5376.0, 8320.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 6016.0, 5376.0, 270.000, 'h007')
    set gg_unit_h00A_0064=BlzCreateUnitWithSkin(p, 'h00A', 5312.0, 8000.0, 270.000, 'h00A')
    set gg_unit_h004_0065=BlzCreateUnitWithSkin(p, 'h004', 7744.0, 6592.0, 270.000, 'h004')
    set u=BlzCreateUnitWithSkin(p, 'h009', 7040.0, 6400.0, 270.000, 'h009')
    set gg_unit_h004_0068=BlzCreateUnitWithSkin(p, 'h004', 6592.0, 7744.0, 270.000, 'h004')
    set gg_unit_h003_0070=BlzCreateUnitWithSkin(p, 'h003', 6464.0, 6464.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h007', 4864.0, 6912.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5120.0, 7040.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5376.0, 7680.0, 270.000, 'h007')
    set gg_unit_h003_0074=BlzCreateUnitWithSkin(p, 'h003', 6208.0, 7360.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h007', 4864.0, 5632.0, 270.000, 'h007')
    set gg_unit_h003_0076=BlzCreateUnitWithSkin(p, 'h003', 7360.0, 6208.0, 270.000, 'h003')
    set u=BlzCreateUnitWithSkin(p, 'h006', 4544.0, 6976.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7680.0, 5376.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7040.0, 5120.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 6912.0, 4864.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 8320.0, 5376.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7936.0, 4864.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7680.0, 5760.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 6912.0, 5504.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7808.0, 6016.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 7680.0, 6272.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h009', 6400.0, 7040.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5376.0, 6016.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 4992.0, 5888.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 4864.0, 7936.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h009', 7552.0, 7040.0, 270.000, 'h009')
    set u=BlzCreateUnitWithSkin(p, 'h007', 4480.0, 5760.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h007', 6016.0, 7808.0, 270.000, 'h007')
    set gg_unit_h00A_0095=BlzCreateUnitWithSkin(p, 'h00A', 8000.0, 5312.0, 270.000, 'h00A')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5504.0, 6912.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h001', 7296.0, 7296.0, 270.000, 'h001')
    set u=BlzCreateUnitWithSkin(p, 'h006', 5312.0, 4672.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', 4672.0, 5312.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h007', 5760.0, 7680.0, 270.000, 'h007')
    set u=BlzCreateUnitWithSkin(p, 'h006', 6976.0, 4544.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', 4544.0, 7744.0, 270.000, 'h006')
    set u=BlzCreateUnitWithSkin(p, 'h006', 7744.0, 4544.0, 270.000, 'h006')
    set gg_unit_n000_0105=BlzCreateUnitWithSkin(p, 'n000', 8640.0, 8640.0, 270.000, 'n000')
    set u=BlzCreateUnitWithSkin(p, 'h016', 6912.0, - 768.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', - 896.0, 6912.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', 1216.0, 6976.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', 6976.0, 1088.0, 270.000, 'h016')
    set u=BlzCreateUnitWithSkin(p, 'h016', 3072.0, 3072.0, 270.000, 'h016')
endfunction
...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set gg_unit_n00K_0007=BlzCreateUnitWithSkin(p, 'n00K', 7942.0, - 3766.4, 134.840, 'n00K')
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_CornerTop=Rect(- 2304.0, 6016.0, - 1920.0, 6400.0)
    set gg_rct_CornerBot=Rect(6016.0, - 2304.0, 6400.0, - 1920.0)
    set gg_rct_CenterMid=Rect(1792.0, 1792.0, 2304.0, 2304.0)
    set gg_rct_GreenCastle=Rect(- 3200.0, - 3200.0, - 2688.0, - 2688.0)
    set gg_rct_GreenTop=Rect(- 3520.0, - 128.0, - 3008.0, 384.0)
    set gg_rct_GreenBot=Rect(- 128.0, - 3520.0, 384.0, - 3008.0)
    set gg_rct_GreenMid=Rect(- 768.0, - 768.0, - 256.0, - 256.0)
    set gg_rct_BrownMid=Rect(4352.0, 4352.0, 4864.0, 4864.0)
    set gg_rct_GreenSpawnTop=Rect(- 3392.0, - 2048.0, - 3136.0, - 1792.0)
    set gg_rct_GreenSpawnMid=Rect(- 2304.0, - 2304.0, - 2048.0, - 2048.0)
    set gg_rct_GreenSpawnBot=Rect(- 2048.0, - 3392.0, - 1792.0, - 3136.0)
    ...
    set gg_rct_BrownSpawnBot=Rect(7232.0, 5888.0, 7488.0, 6144.0)
    set gg_rct_BrownSpawnMid=Rect(6144.0, 6144.0, 6400.0, 6400.0)
    set gg_rct_BrownSpawnTop=Rect(5888.0, 7232.0, 6144.0, 7488.0)
    set gg_rct_BrownBot=Rect(7104.0, 3712.0, 7616.0, 4224.0)
    set gg_rct_BrownTop=Rect(3712.0, 7104.0, 4224.0, 7616.0)
    set gg_rct_CornerTopGreen=Rect(- 2688.0, 5376.0, - 2304.0, 5760.0)
    ...
    set gg_rct_GreenWorkShopTop=Rect(- 3840.0, - 1152.0, - 3584.0, - 896.0)
    set gg_rct_GreenWorkShopBot=Rect(- 1152.0, - 3840.0, - 896.0, - 3584.0)
    set gg_rct_BrownWorkShopTop=Rect(4992.0, 7680.0, 5248.0, 7936.0)
    set gg_rct_BrownWorkShopBot=Rect(7680.0, 4992.0, 7936.0, 5248.0)
    ...
    set gg_rct_BrownPortBot=Rect(6848.0, - 704.0, 7232.0, - 320.0)
    set gg_rct_GreenPortBot=Rect(4544.0, - 3168.0, 4928.0, - 2784.0)
    set gg_rct_GreenPortTop=Rect(- 3392.0, 4544.0, - 3008.0, 4928.0)
    set gg_rct_BrownPortTop=Rect(- 832.0, 7104.0, - 448.0, 7488.0)
    set gg_rct_BrownPortMid=Rect(3392.0, 3264.0, 3776.0, 3648.0)
    set gg_rct_GreenPortMid=Rect(320.0, 448.0, 704.0, 832.0)
    set gg_rct_GreenTopHome=Rect(- 3776.0, - 256.0, - 2752.0, 512.0)
    set gg_rct_GreenMidHome=Rect(- 1024.0, - 1024.0, 0.0, 0.0)
    set gg_rct_GreenBotHome=Rect(- 256.0, - 3776.0, 512.0, - 2752.0)
    set gg_rct_BrownBotHome=Rect(6848.0, 3584.0, 7872.0, 4352.0)
    set gg_rct_BrownMidHome=Rect(4096.0, 4096.0, 5120.0, 5120.0)
    set gg_rct_BrownTopHome=Rect(3584.0, 6848.0, 4352.0, 7872.0)

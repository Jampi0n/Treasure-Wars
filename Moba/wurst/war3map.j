...
function CreateUnitsForPlayer0 takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'H000', - 2160.2, - 2457.9, 95.727)
    set u=CreateUnit(p, 'H00I', - 1915.8, - 2353.7, 90.025)
    set u=CreateUnit(p, 'H00J', - 1975.2, - 2714.2, 292.685)
endfunction

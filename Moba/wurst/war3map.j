...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u=CreateUnit(p, 'ntrg', - 4034.0, - 978.6, 77.346)
    set u=CreateUnit(p, 'ntrs', - 3427.0, - 1588.0, 58.032)
    set u=CreateUnit(p, 'nlds', - 2607.5, - 36.0, 26.104)
    set u=CreateUnit(p, 'nlpd', - 3828.1, 632.2, 280.731)
    set u=CreateUnit(p, 'nmtw', - 1649.5, 375.5, 285.576)
endfunction
